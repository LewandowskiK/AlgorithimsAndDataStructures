...
public class TestEncryptor {
    public static void main(String[] args) {
        System.out.println(Encryptor.encryptRowColumn("This is a secret message", 6));
        System.out.println(Encryptor.decryptRowColumn(Encryptor.encryptRowColumn("This is a secret message", 6),6));
